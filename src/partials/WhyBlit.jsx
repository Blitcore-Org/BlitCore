...
export default function WhyBlit() {
  return (
      ...
      <div className="max-w-1xl mx-auto text-center pb-12 md:pb-16">
        ...
        <div className="container m-auto px-6 text-gray-500 md:px-12 xl:px-0">
          <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-2">
            <div className="contactBg rounded-3xl drop-shadow-2xl px-8 py-12 sm:px-12 lg:px-8">
              <div className="mb-12 space-y-4">
                <h3 className="text-2xl font-semibold text-blitblue-500">
