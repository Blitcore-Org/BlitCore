    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="customsoftwaredev" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Custom Software Development</Link>
              </li>
              <li className="mb-2">
                <Link to="webdev" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Web Development</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">E-commerce Development</Link>
              </li>
              <li className="mb-2">
                <Link to="qa" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Software Testing and QA</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">UI/UX Design</Link>
              </li>                            
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://cruip.com/">BlitCore</a>. All rights reserved.</div>
