      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-blitblue-100">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="customsoftwaredev" className="text-blittext-100 hover:text-blitblue-500 transition duration-150 ease-in-out">Custom Software Development</Link>
              </li>
              <li className="mb-2">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link to="#" className="text-blittext-100 hover:text-blitblue-500 transition duration-150 ease-in-out">Contact Us</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-blittext-100 hover:text-blitblue-500 transition duration-150 ease-in-out">Privacy Policy</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-blitblue-100">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <Link to="#" className="flex justify-center items-center bg-blitblue-400 hover:text-blitblue-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <Link to="#" className="flex justify-center items-center  bg-blitblue-400 hover:text-blitblue-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <Link to="#" className="flex justify-center items-center  bg-blitblue-400 hover:text-blitblue-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-blittext-100 mr-4">Made by <a className="text-blitblue-400 hover:underline" href="https://blitcore.com/">BlitCore</a>. All rights reserved.</div>
