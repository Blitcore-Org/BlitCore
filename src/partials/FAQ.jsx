export default function FAQ(){
    ...
    return (
 <section class="relative min-w-screen animation-fade animation-delay mt-20">
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
        <p class="text-center text-xs font-bold text-left text-blittext-100 uppercase sm:mx-6 sm:text-center sm:text-normal sm:font-bold">
